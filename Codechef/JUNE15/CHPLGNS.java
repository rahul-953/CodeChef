...
class CHPLGNS
{
	...
	{	 
		...
		int i;
		//System.out.println("xsum = "+xsum+" ysum = "+ysum+" check = "+(1000000000*1000000000));	
		for (i=0; i<x.length-1; i++)
		{
			xsum += x[i]*y[i+1];
			ysum += y[i]*x[i+1]; 
			//System.out.println("xsum = "+xsum+"  ysum = "+ysum);		
		}
		...
		//System.out.println("Area is = "+area+" xsum = "+xsum+" ysum = "+ysum);
		return area;
	}
}
