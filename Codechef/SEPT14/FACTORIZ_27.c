    ...
    2 â�¤ N â�¤ 1018, N is picked randomly and uniformly - 10% of all test data
    2 â�¤ N â�¤ 1018, N is picked not randomly - 15% of all test data
    2 â�¤ N â�¤ 101000, the length of N is chosen randomly. All the digits are generated randomly - 50% of all test data.
    2 â�¤ N â�¤ 101000, all the prime divisors of N don't exceed 1018 - 25% of the test data.
    Example
    Input:
    4
    100
