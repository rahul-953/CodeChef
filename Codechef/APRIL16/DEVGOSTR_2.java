...
class DEVGOSTR_2 {
	...
	static LinkedList<String> twenty[] = new LinkedList[51];
	...
	public static void main(String arg[]) throws IOException {
		...
		for (int ll = 0; ll < 51; ll++) {
			twenty[ll] = new LinkedList<String>();
		}
		...
		while (t-- > 0) {
			...
			if (len >= 3 && A == 1) {
				 ...
				 * else if(A==3 && len>=27 && len<=50){ pw.println("0"); }
				 */else if (A == 3) {
				/// int dem = len%10;
				for (String saved : twenty[len]) {
