...
class DEVGOSTR_22 {
	...
	public static void main(String arg[]) throws IOException {
		...
		while (t-- > 0) {
			...
			if (temp.length() >= 3 && A == 1) {
				...
				total = new String[(int) (Math.pow(A, temp.length()))];
				String str = "";
				...
				ArrayList<String> nonGood = Count_Number_Of_Not_Good_Strings(total);
				// pw.println();
				int ans = 0;
	...
	public static ArrayList<String> Count_Number_Of_Not_Good_Strings(String total[]) {

		int len = total[0].length();
