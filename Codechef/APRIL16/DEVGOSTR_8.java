...
class DEVGOSTR_8 {
	...
	public static void main(String arg[]) throws IOException {
		...
		/*
		 * for(int l = 13;l<=27;l++){ long start = System.nanoTime();
		 * AllPermutationString(0,3,l,"",l+1,"abcdefghijklmnopqrtsuvwxyzza");
		 * long end = System.nanoTime(); System.out.println("Time for len = "+l+
